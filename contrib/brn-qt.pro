...
RESOURCES += src/qt/brn.qrc src/qt/brn_locale.qrc

TRANSLATIONS += src/qt/locale/brn_bg.ts \
                src/qt/locale/brn_de.ts \
                src/qt/locale/brn_en.ts \
                src/qt/locale/brn_es.ts \
                src/qt/locale/brn_fi.ts \
                src/qt/locale/brn_fr.ts \
                src/qt/locale/brn_it.ts \
                src/qt/locale/brn_ja.ts \
                src/qt/locale/brn_pl.ts \
                src/qt/locale/brn_pt.ts \
                src/qt/locale/brn_ru.ts \
                src/qt/locale/brn_sk.ts \
                src/qt/locale/brn_sv.ts \
                src/qt/locale/brn_vi.ts \
                src/qt/locale/brn_zh_CN.ts \
                src/qt/locale/brn_zh_TW.ts
