...
In order to support loading of multiple wallets in brn-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is brn.cpp.
...
Changes to brn.cpp
----------------------
brn.cpp is the entry point into brn-qt, and as such, will require some minor modifications to provide hooks for
