Contributing to BuranCoin Core
============================

The BuranCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BuranCoin Core project, and is not to be
confused with overall BRN Network Protocol consensus changes.

Whether a pull request is merged into BuranCoin Core rests with the project merge
...
Patches that change BRN consensus rules are considerably more involved than
...
Where a patch set proposes to change the BRN consensus, it must have been
...
The project leader is the release manager for each BuranCoin Core release.
