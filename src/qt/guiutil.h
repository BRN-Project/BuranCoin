...
/** Utility functions used by the BuranCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render BuranCoin addresses in monospace font
...
// Parse "brn:" URI into recipient object, return true on successful parsing
