                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BuranCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BuranCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and brn: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BuranCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about BuranCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BuranCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BuranCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BuranCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a BuranCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BuranCoin Core help message to get a list with possible BuranCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BuranCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BuranCoin network", "", count));
}
...
{
    QString strTitle = tr("BuranCoin Core"); // default title
