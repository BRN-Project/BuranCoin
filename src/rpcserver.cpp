...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BuranCoin features */
        {"brn", "masternode", &masternode, true, true, false},
        {"brn", "masternodelist", &masternodelist, true, true, false},
        {"brn", "mnbudget", &mnbudget, true, true, false},
        {"brn", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"brn", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"brn", "mnsync", &mnsync, true, true, false},
        {"brn", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"brn", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use brnd, or the -server option to brn-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> brn-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:36261/\n";
}
